...
class ConnectionManager:
    ...
    async def cleanup_stale_connections(self, sio):
        ...
        for sid, connection in self.connections.items():
            ...
            elif memory_mb > 250 and connection_age > CONNECTION_TIMEOUT / 2:
                stale_sids.append(sid)
    ...
    def _get_client_ip(self, environ: dict) -> str:
        ...
        if forwarded:
            return forwarded
        return environ.get('HTTP_X_REAL_IP', environ.get('REMOTE_ADDR', 'unknown'))
